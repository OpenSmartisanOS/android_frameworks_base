...
abstract class ShadeModule {
    companion object {
        ...
        fun provideBaseShadeInteractor(
            legacyInteractor: ShadeInteractorLegacyImpl,
        ): BaseShadeInteractor = legacyInteractor

        @Provides
        @SysUISingleton
        fun provideShadeController(
            legacyController: ShadeControllerImpl,
        ): ShadeController = legacyController

        @Provides
        @SysUISingleton
        fun provideShadeAnimationInteractor(
            legacyInteractor: ShadeAnimationInteractorLegacyImpl,
        ): ShadeAnimationInteractor = legacyInteractor

        @Provides
        @SysUISingleton
        fun provideShadeBackActionInteractor(
            notificationPanelViewController: NotificationPanelViewController,
        ): ShadeBackActionInteractor = notificationPanelViewController

        @Provides
        @SysUISingleton
        fun provideShadeLockscreenInteractor(
            notificationPanelViewController: NotificationPanelViewController,
        ): ShadeLockscreenInteractor = notificationPanelViewController

        @Provides
        @SysUISingleton
        fun providePanelExpansionInteractor(
            notificationPanelViewController: NotificationPanelViewController,
        ): PanelExpansionInteractor = notificationPanelViewController

        @Provides
        @SysUISingleton
        fun provideQuickSettingsController(
            quickSettingsController: QuickSettingsControllerImpl,
