...
/**
 * Per-display component for the canonical {@link PhoneStatusBarView}. The component is recreated
 * with its status-bar window and owns every controller scoped to that concrete view instance.
 */
